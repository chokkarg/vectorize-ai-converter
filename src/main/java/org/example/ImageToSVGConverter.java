...
public class ImageToSVGConverter {
    ...
    private static final String folderPath =  "I:\\My Drive\\Generated-Midjouney\\Upscaled_photo\\General";
                ...
                try {
                    ...
                    Request postRequest = Request.post("https://vectorizer.ai/api/v1/vectorize")
                            ...
                            .body(MultipartEntityBuilder.create()
                                    .addBinaryBody("image", file, ContentType.create("image/png"), file.getName())
                                    .build());
                    ...
                    if (response.getCode() == 200) {
                        File output = new File(inputFolder, file.getName().replace(".png", ".svg"));
